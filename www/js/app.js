...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module('lightApp', ['ionic', 'lightApp.controllers', 'lightApp.services']).config(appConfiguration).run(appRun);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _controllersDashboardController = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionController = function ActionController(ParticleService) {
	  _classCallCheck(this, ActionController);

	  (0, _lodash.assign)(this, { ParticleService: ParticleService });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DashboardController = (function () {
	  function DashboardController(ParticleService) {
	  ...
	  _createClass(DashboardController, [{
	    key: 'connectToDevice',
	    value: function connectToDevice() {
	      var _this = this;

	      this.ParticleService.login().then(function () {
	        return _this.ParticleService.connectToDevice();
	      }).then(function (device) {
	        _this.isDeviceConnected = true;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _servicesParticleService = __webpack_require__(8);

	var _servicesParticleService2 = _interopRequireDefault(_servicesParticleService);

	exports['default'] = angular.module('lightApp.services', []).service('ParticleService', _servicesParticleService2['default']);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ParticleService = (function () {
	  function ParticleService($q) {
	    _classCallCheck(this, ParticleService);

	    (0, _lodash.assign)(this, { $q: $q });
	    this.connectedDevice = null;
	  }

	  _createClass(ParticleService, [{
	    key: 'login',
	    ...
	    value: function connectToDevice() {
	      ...
	      return this.$q.when(spark.listDevices()).then(function (devices) {
	        var device = _.findWhere(devices, { name: 'CarlosCore' }),
